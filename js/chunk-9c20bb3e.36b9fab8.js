...
var Presentation1 = function Presentation1() {
  return __webpack_require__.e(/* import() */ "chunk-23c203ca").then(__webpack_require__.bind(null, "3599"));
};
...
/* harmony default export */ var PresentationModalvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    reRenderPresentation: function reRenderPresentation() {
      ...
      if (this.openedPresentationId !== null) {
        this.updateCurSlideOverride(this.$refs.presentation1.curSlide);
        var openedPresentationId = this.openedPresentationId;
        this.openedPresentationId = 0;
        setTimeout(function () {
          _this.openedPresentationId = openedPresentationId;
        }, 0);
      }
    },
...
//# sourceMappingURL=chunk-9c20bb3e.36b9fab8.js.map